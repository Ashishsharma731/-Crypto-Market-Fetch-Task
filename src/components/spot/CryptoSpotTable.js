...
import { connectBinanceSpotWebSocket } from "@/utils/binance/binanceSpotWebSocket";

export default function CryptoSpotTable() {
  ...
  useEffect(() => {
    const socket = connectBinanceSpotWebSocket(setPrices);
